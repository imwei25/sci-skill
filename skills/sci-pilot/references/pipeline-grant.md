...
4. **新颖性裁定 + 预注册（选定后，停下拍板）**：`novelty-check` 对选定课题做严格新颖性裁定（真新/增量/已被回答/有争议，含 ChiCTR/PROSPERO 注册库检索）→ `checks/novelty_assessment.md`；裁定"已被回答"要停下重构。临床试验/前瞻研究再出预注册草案 → `drafts/preregistration.md`（提示用户去 ChiCTR/OSF 正式注册、回填真实注册号）。
